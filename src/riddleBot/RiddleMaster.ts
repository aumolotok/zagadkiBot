...
*Внимание!* Раз в 10 минут можно запросить только *один* тип подсказки`;
    ...
    private mapOfRiddles = 
        new Map<string, Riddle>()
            ...
            .set("2", new Riddle(
                "Собака неплохо соблюдает _дресс код_. Да и фото отличное. Пришли фото с собакой тех же принципов. Картинки из инета не канают",
    ...
    getRiddle(key: string) : Riddle | undefined {
        ...
        return new Riddle(RiddleMaster.noRiddle)
    }
